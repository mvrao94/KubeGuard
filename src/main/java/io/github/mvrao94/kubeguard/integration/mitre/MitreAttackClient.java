 ...
 * Optimized with caching and fast lookups
 */
@Service
public class MitreAttackClient {
   ...
   * Uses cached immutable list for performance
   */
  ...
  private List<MitreTechnique> loadTechniques() {
    ...
    TechniqueData[] techniqueData = {
        // Initial Access
        new TechniqueData("T1190", "Exploit Public-Facing Application", "Initial Access",
        ...
        // Execution
        new TechniqueData("T1609", "Container Administration Command", "Execution",
        ...
        new TechniqueData("T1610", "Deploy Container", "Execution",
        ...
        // Persistence
        new TechniqueData("T1525", "Implant Internal Image", "Persistence",
        ...
        new TechniqueData("T1053", "Scheduled Task/Job", "Persistence",
            "Adversaries may use CronJobs for persistence",
            List.of("CronJob", "Job"),
            List.of("Monitor CronJob creation", "Restrict scheduling permissions")),

        // Privilege Escalation
        new TechniqueData("T1611", "Escape to Host", "Privilege Escalation",
        ...
        new TechniqueData("T1548", "Abuse Elevation Control Mechanism", "Privilege Escalation",
        ...
        // Defense Evasion
        new TechniqueData("T1562", "Impair Defenses", "Defense Evasion",
        ...
        new TechniqueData("T1070", "Indicator Removal", "Defense Evasion",
        ...
        // Credential Access
        new TechniqueData("T1552", "Unsecured Credentials", "Credential Access",
        ...
        new TechniqueData("T1078", "Valid Accounts", "Credential Access",
        ...
        // Discovery
        new TechniqueData("T1613", "Container and Resource Discovery", "Discovery",
        ...
        new TechniqueData("T1046", "Network Service Discovery", "Discovery",
        ...
        // Lateral Movement
        new TechniqueData("T1021", "Remote Services", "Lateral Movement",
            "Adversaries may use remote services to move laterally",
            List.of("Service", "Pod"),
            List.of("Network policies", "Service mesh", "mTLS")),

        new TechniqueData("T1534", "Internal Spearphishing", "Lateral Movement",
        ...
        // Collection
        new TechniqueData("T1530", "Data from Cloud Storage", "Collection",
        ...
        // Impact
        new TechniqueData("T1496", "Resource Hijacking", "Impact",
        ...
        new TechniqueData("T1499", "Endpoint Denial of Service", "Impact",
        ...
        new TechniqueData("T1485", "Data Destruction", "Impact",
        ...
        // Network
        new TechniqueData("T1599", "Network Boundary Bridging", "Defense Evasion",
        ...
        new TechniqueData("T1040", "Network Sniffing", "Credential Access",
