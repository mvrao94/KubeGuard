...
public class ScanResponse {
    ...
    @Schema(description = "Unique identifier for the scan", example = "123e4567-e89b-12d3-a456-426614174000")
    private String scanId;

    @Schema(description = "Response message", example = "Scan started successfully")
    private String message;

    @Schema(description = "Current status of the scan", example = "RUNNING",
